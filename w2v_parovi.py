...
w2v_df = pd.read_pickle('springer_dataframe_5_categories.p')
...
with mlflow.start_run():
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        print(f"Epoch [{epoch+1:02d}/{NUM_EPOCHS}] -> Train Loss: {epoch_loss:.4f} | Val Loss: {epoch_val_loss:.4f} | Val Accuracy: {val_accuracy:.2f}%")            model.eval()
